...
test('service worker precaches the complete app shell', async () => {
  ...
  for (const asset of ['./index.html', './styles.css', './src/app.mjs', './src/domain/share.mjs', './src/locales/it.mjs', './src/locales/en.mjs', './manifest.webmanifest', './assets/reward-token.webp', './assets/tool-markdown.webp', './assets/tool-protect.webp', './assets/tool-prepare.webp', './assets/tool-history.webp']) {
